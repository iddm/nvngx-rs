...
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_Default: NVSDK_NGX_DLSS_Hint_Render_Preset = 0;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_A: NVSDK_NGX_DLSS_Hint_Render_Preset = 1;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_B: NVSDK_NGX_DLSS_Hint_Render_Preset = 2;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_C: NVSDK_NGX_DLSS_Hint_Render_Preset = 3;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_D: NVSDK_NGX_DLSS_Hint_Render_Preset = 4;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_E: NVSDK_NGX_DLSS_Hint_Render_Preset = 5;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_F: NVSDK_NGX_DLSS_Hint_Render_Preset = 6;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_G: NVSDK_NGX_DLSS_Hint_Render_Preset = 7;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_H_Reserved: NVSDK_NGX_DLSS_Hint_Render_Preset = 8;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_I_Reserved: NVSDK_NGX_DLSS_Hint_Render_Preset = 9;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_J: NVSDK_NGX_DLSS_Hint_Render_Preset = 10;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_K: NVSDK_NGX_DLSS_Hint_Render_Preset = 11;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_L: NVSDK_NGX_DLSS_Hint_Render_Preset = 12;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_M: NVSDK_NGX_DLSS_Hint_Render_Preset = 13;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_N: NVSDK_NGX_DLSS_Hint_Render_Preset = 14;
pub const NVSDK_NGX_DLSS_Hint_Render_Preset_O: NVSDK_NGX_DLSS_Hint_Render_Preset = 15;
pub type NVSDK_NGX_DLSS_Hint_Render_Preset = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct NVSDK_NGX_FeatureCommonInfo_Internal {
    _unused: [u8; 0],
}
pub const NVSDK_NGX_Version_API: NVSDK_NGX_Version = 21;
pub type NVSDK_NGX_Version = ::std::os::raw::c_int;
pub const NVSDK_NGX_Result_Success: NVSDK_NGX_Result = 1;
pub const NVSDK_NGX_Result_Fail: NVSDK_NGX_Result = -1160773632;
pub const NVSDK_NGX_Result_FAIL_FeatureNotSupported: NVSDK_NGX_Result = -1160773631;
pub const NVSDK_NGX_Result_FAIL_PlatformError: NVSDK_NGX_Result = -1160773630;
pub const NVSDK_NGX_Result_FAIL_FeatureAlreadyExists: NVSDK_NGX_Result = -1160773629;
pub const NVSDK_NGX_Result_FAIL_FeatureNotFound: NVSDK_NGX_Result = -1160773628;
pub const NVSDK_NGX_Result_FAIL_InvalidParameter: NVSDK_NGX_Result = -1160773627;
pub const NVSDK_NGX_Result_FAIL_ScratchBufferTooSmall: NVSDK_NGX_Result = -1160773626;
pub const NVSDK_NGX_Result_FAIL_NotInitialized: NVSDK_NGX_Result = -1160773625;
pub const NVSDK_NGX_Result_FAIL_UnsupportedInputFormat: NVSDK_NGX_Result = -1160773624;
pub const NVSDK_NGX_Result_FAIL_RWFlagMissing: NVSDK_NGX_Result = -1160773623;
pub const NVSDK_NGX_Result_FAIL_MissingInput: NVSDK_NGX_Result = -1160773622;
pub const NVSDK_NGX_Result_FAIL_UnableToInitializeFeature: NVSDK_NGX_Result = -1160773621;
pub const NVSDK_NGX_Result_FAIL_OutOfDate: NVSDK_NGX_Result = -1160773620;
pub const NVSDK_NGX_Result_FAIL_OutOfGPUMemory: NVSDK_NGX_Result = -1160773619;
pub const NVSDK_NGX_Result_FAIL_UnsupportedFormat: NVSDK_NGX_Result = -1160773618;
pub const NVSDK_NGX_Result_FAIL_UnableToWriteToAppDataPath: NVSDK_NGX_Result = -1160773617;
pub const NVSDK_NGX_Result_FAIL_UnsupportedParameter: NVSDK_NGX_Result = -1160773616;
pub const NVSDK_NGX_Result_FAIL_Denied: NVSDK_NGX_Result = -1160773615;
pub const NVSDK_NGX_Result_FAIL_NotImplemented: NVSDK_NGX_Result = -1160773614;
pub type NVSDK_NGX_Result = ::std::os::raw::c_int;
pub const NVSDK_NGX_Feature_Reserved0: NVSDK_NGX_Feature = 0;
pub const NVSDK_NGX_Feature_SuperSampling: NVSDK_NGX_Feature = 1;
pub const NVSDK_NGX_Feature_InPainting: NVSDK_NGX_Feature = 2;
pub const NVSDK_NGX_Feature_ImageSuperResolution: NVSDK_NGX_Feature = 3;
pub const NVSDK_NGX_Feature_SlowMotion: NVSDK_NGX_Feature = 4;
pub const NVSDK_NGX_Feature_VideoSuperResolution: NVSDK_NGX_Feature = 5;
pub const NVSDK_NGX_Feature_Reserved1: NVSDK_NGX_Feature = 6;
pub const NVSDK_NGX_Feature_Reserved2: NVSDK_NGX_Feature = 7;
pub const NVSDK_NGX_Feature_Reserved3: NVSDK_NGX_Feature = 8;
pub const NVSDK_NGX_Feature_ImageSignalProcessing: NVSDK_NGX_Feature = 9;
pub const NVSDK_NGX_Feature_DeepResolve: NVSDK_NGX_Feature = 10;
pub const NVSDK_NGX_Feature_FrameGeneration: NVSDK_NGX_Feature = 11;
pub const NVSDK_NGX_Feature_DeepDVC: NVSDK_NGX_Feature = 12;
pub const NVSDK_NGX_Feature_RayReconstruction: NVSDK_NGX_Feature = 13;
pub const NVSDK_NGX_Feature_Reserved14: NVSDK_NGX_Feature = 14;
pub const NVSDK_NGX_Feature_Reserved15: NVSDK_NGX_Feature = 15;
pub const NVSDK_NGX_Feature_Reserved16: NVSDK_NGX_Feature = 16;
pub const NVSDK_NGX_Feature_Count: NVSDK_NGX_Feature = 17;
pub const NVSDK_NGX_Feature_Reserved_SDK: NVSDK_NGX_Feature = 32764;
pub const NVSDK_NGX_Feature_Reserved_Core: NVSDK_NGX_Feature = 32765;
pub const NVSDK_NGX_Feature_Reserved_Unknown: NVSDK_NGX_Feature = 32766;
pub type NVSDK_NGX_Feature = ::std::os::raw::c_int;
pub const NVSDK_NGX_Buffer_Format_Unknown: NVSDK_NGX_Buffer_Format = 0;
pub const NVSDK_NGX_Buffer_Format_RGB8UI: NVSDK_NGX_Buffer_Format = 1;
pub const NVSDK_NGX_Buffer_Format_RGB16F: NVSDK_NGX_Buffer_Format = 2;
pub const NVSDK_NGX_Buffer_Format_RGB32F: NVSDK_NGX_Buffer_Format = 3;
pub const NVSDK_NGX_Buffer_Format_RGBA8UI: NVSDK_NGX_Buffer_Format = 4;
pub const NVSDK_NGX_Buffer_Format_RGBA16F: NVSDK_NGX_Buffer_Format = 5;
pub const NVSDK_NGX_Buffer_Format_RGBA32F: NVSDK_NGX_Buffer_Format = 6;
pub type NVSDK_NGX_Buffer_Format = ::std::os::raw::c_int;
pub const NVSDK_NGX_PerfQuality_Value_MaxPerf: NVSDK_NGX_PerfQuality_Value = 0;
pub const NVSDK_NGX_PerfQuality_Value_Balanced: NVSDK_NGX_PerfQuality_Value = 1;
pub const NVSDK_NGX_PerfQuality_Value_MaxQuality: NVSDK_NGX_PerfQuality_Value = 2;
pub const NVSDK_NGX_PerfQuality_Value_UltraPerformance: NVSDK_NGX_PerfQuality_Value = 3;
pub const NVSDK_NGX_PerfQuality_Value_UltraQuality: NVSDK_NGX_PerfQuality_Value = 4;
pub const NVSDK_NGX_PerfQuality_Value_DLAA: NVSDK_NGX_PerfQuality_Value = 5;
pub type NVSDK_NGX_PerfQuality_Value = ::std::os::raw::c_int;
pub const NVSDK_NGX_RTX_Value_Off: NVSDK_NGX_RTX_Value = 0;
pub const NVSDK_NGX_RTX_Value_On: NVSDK_NGX_RTX_Value = 1;
pub type NVSDK_NGX_RTX_Value = ::std::os::raw::c_int;
pub const NVSDK_NGX_DLSS_Mode_Off: NVSDK_NGX_DLSS_Mode = 0;
pub const NVSDK_NGX_DLSS_Mode_DLSS_DLISP: NVSDK_NGX_DLSS_Mode = 1;
pub const NVSDK_NGX_DLSS_Mode_DLISP_Only: NVSDK_NGX_DLSS_Mode = 2;
pub const NVSDK_NGX_DLSS_Mode_DLSS: NVSDK_NGX_DLSS_Mode = 3;
pub type NVSDK_NGX_DLSS_Mode = ::std::os::raw::c_int;
#[repr(C)]
...
pub const NVSDK_NGX_GPU_Arch_NotSupported: NVSDK_NGX_GPU_Arch = 0;
pub const NVSDK_NGX_GPU_Arch_Volta: NVSDK_NGX_GPU_Arch = 320;
pub const NVSDK_NGX_GPU_Arch_Turing: NVSDK_NGX_GPU_Arch = 352;
pub const NVSDK_NGX_GPU_Arch_Ampere: NVSDK_NGX_GPU_Arch = 368;
pub const NVSDK_NGX_GPU_Arch_Ada: NVSDK_NGX_GPU_Arch = 400;
pub const NVSDK_NGX_GPU_Arch_Hopper: NVSDK_NGX_GPU_Arch = 384;
pub const NVSDK_NGX_GPU_Arch_Blackwell: NVSDK_NGX_GPU_Arch = 416;
pub const NVSDK_NGX_GPU_Arch_Blackwell2: NVSDK_NGX_GPU_Arch = 432;
pub const NVSDK_NGX_GPU_Arch_Unknown: NVSDK_NGX_GPU_Arch = 134217727;
pub type NVSDK_NGX_GPU_Arch = ::std::os::raw::c_int;
...
pub const NVSDK_NGX_TONEMAPPER_STRING: NVSDK_NGX_ToneMapperType = 0;
pub const NVSDK_NGX_TONEMAPPER_REINHARD: NVSDK_NGX_ToneMapperType = 1;
pub const NVSDK_NGX_TONEMAPPER_ONEOVERLUMA: NVSDK_NGX_ToneMapperType = 2;
pub const NVSDK_NGX_TONEMAPPER_ACES: NVSDK_NGX_ToneMapperType = 3;
pub const NVSDK_NGX_TONEMAPPERTYPE_NUM: NVSDK_NGX_ToneMapperType = 4;
pub type NVSDK_NGX_ToneMapperType = ::std::os::raw::c_int;
pub const NVSDK_NGX_GBUFFER_ALBEDO: NVSDK_NGX_GBufferType = 0;
pub const NVSDK_NGX_GBUFFER_ROUGHNESS: NVSDK_NGX_GBufferType = 1;
pub const NVSDK_NGX_GBUFFER_METALLIC: NVSDK_NGX_GBufferType = 2;
pub const NVSDK_NGX_GBUFFER_SPECULAR: NVSDK_NGX_GBufferType = 3;
pub const NVSDK_NGX_GBUFFER_SUBSURFACE: NVSDK_NGX_GBufferType = 4;
pub const NVSDK_NGX_GBUFFER_NORMALS: NVSDK_NGX_GBufferType = 5;
pub const NVSDK_NGX_GBUFFER_SHADINGMODELID: NVSDK_NGX_GBufferType = 6;
pub const NVSDK_NGX_GBUFFER_MATERIALID: NVSDK_NGX_GBufferType = 7;
pub const NVSDK_NGX_GBUFFER_SPECULAR_ALBEDO: NVSDK_NGX_GBufferType = 8;
pub const NVSDK_NGX_GBUFFER_INDIRECT_ALBEDO: NVSDK_NGX_GBufferType = 9;
pub const NVSDK_NGX_GBUFFER_SPECULAR_MVEC: NVSDK_NGX_GBufferType = 10;
pub const NVSDK_NGX_GBUFFER_DISOCCL_MASK: NVSDK_NGX_GBufferType = 11;
pub const NVSDK_NGX_GBUFFER_EMISSIVE: NVSDK_NGX_GBufferType = 12;
pub const NVSDK_NGX_GBUFFERTYPE_NUM: NVSDK_NGX_GBufferType = 16;
pub type NVSDK_NGX_GBufferType = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub const NVSDK_NGX_LOGGING_LEVEL_OFF: NVSDK_NGX_Logging_Level = 0;
pub const NVSDK_NGX_LOGGING_LEVEL_ON: NVSDK_NGX_Logging_Level = 1;
pub const NVSDK_NGX_LOGGING_LEVEL_VERBOSE: NVSDK_NGX_Logging_Level = 2;
pub const NVSDK_NGX_LOGGING_LEVEL_NUM: NVSDK_NGX_Logging_Level = 3;
pub type NVSDK_NGX_Logging_Level = ::std::os::raw::c_int;
...
pub const NVSDK_NGX_OPT_LEVEL_UNDEFINED: NVSDK_NGX_Opt_Level = 0;
pub const NVSDK_NGX_OPT_LEVEL_DEBUG: NVSDK_NGX_Opt_Level = 20;
pub const NVSDK_NGX_OPT_LEVEL_DEVELOP: NVSDK_NGX_Opt_Level = 30;
pub const NVSDK_NGX_OPT_LEVEL_RELEASE: NVSDK_NGX_Opt_Level = 40;
pub type NVSDK_NGX_Opt_Level = ::std::os::raw::c_int;
pub const NVSDK_NGX_ENGINE_TYPE_CUSTOM: NVSDK_NGX_EngineType = 0;
pub const NVSDK_NGX_ENGINE_TYPE_UNREAL: NVSDK_NGX_EngineType = 1;
pub const NVSDK_NGX_ENGINE_TYPE_UNITY: NVSDK_NGX_EngineType = 2;
pub const NVSDK_NGX_ENGINE_TYPE_OMNIVERSE: NVSDK_NGX_EngineType = 3;
pub const NVSDK_NGX_ENGINE_COUNT: NVSDK_NGX_EngineType = 4;
pub type NVSDK_NGX_EngineType = ::std::os::raw::c_int;
pub const NVSDK_NGX_FeatureSupportResult_Supported: NVSDK_NGX_Feature_Support_Result = 0;
pub const NVSDK_NGX_FeatureSupportResult_CheckNotPresent: NVSDK_NGX_Feature_Support_Result = 1;
pub const NVSDK_NGX_FeatureSupportResult_DriverVersionUnsupported:
    NVSDK_NGX_Feature_Support_Result = 2;
pub const NVSDK_NGX_FeatureSupportResult_AdapterUnsupported: NVSDK_NGX_Feature_Support_Result = 4;
pub const NVSDK_NGX_FeatureSupportResult_OSVersionBelowMinimumSupported:
    NVSDK_NGX_Feature_Support_Result = 8;
pub const NVSDK_NGX_FeatureSupportResult_NotImplemented: NVSDK_NGX_Feature_Support_Result = 16;
pub type NVSDK_NGX_Feature_Support_Result = ::std::os::raw::c_int;
pub const NVSDK_NGX_Application_Identifier_Type_Application_Id:
    NVSDK_NGX_Application_Identifier_Type = 0;
pub const NVSDK_NGX_Application_Identifier_Type_Project_Id: NVSDK_NGX_Application_Identifier_Type =
    1;
pub type NVSDK_NGX_Application_Identifier_Type = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type PFN_NVSDK_NGX_DLSS_GetOptimalSettingsCallback = ::std::option::Option<
    unsafe extern "C" fn(InParams: *mut NVSDK_NGX_Parameter) -> NVSDK_NGX_Result,
>;
pub const NVSDK_NGX_DLSS_Denoise_Mode_Off: NVSDK_NGX_DLSS_Denoise_Mode = 0;
pub const NVSDK_NGX_DLSS_Denoise_Mode_DLUnified: NVSDK_NGX_DLSS_Denoise_Mode = 1;
pub type NVSDK_NGX_DLSS_Denoise_Mode = ::std::os::raw::c_int;
pub const NVSDK_NGX_DLSS_Roughness_Mode_Unpacked: NVSDK_NGX_DLSS_Roughness_Mode = 0;
pub const NVSDK_NGX_DLSS_Roughness_Mode_Packed: NVSDK_NGX_DLSS_Roughness_Mode = 1;
pub type NVSDK_NGX_DLSS_Roughness_Mode = ::std::os::raw::c_int;
pub const NVSDK_NGX_DLSS_Depth_Type_Linear: NVSDK_NGX_DLSS_Depth_Type = 0;
pub const NVSDK_NGX_DLSS_Depth_Type_HW: NVSDK_NGX_DLSS_Depth_Type = 1;
pub type NVSDK_NGX_DLSS_Depth_Type = ::std::os::raw::c_int;
...
pub type NVSDK_NGX_RayReconstruction_Hint_Render_Preset = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
