...
fn main() {
    ...
    // Get optimal settings for the target resolution
    ...
    vk_mini_init
        .record_and_submit(|cb, dev| {
            // Transition all inputs to GENERAL
            for img in [
                &mut color_img,
                &mut mv_img,
                &mut depth_img,
            ...
            // Clear all inputs with dummy data
            ...
            rr.evaluate(cb).expect("Ray Reconstruction evaluate");
    ...
    image::save_buffer_with_format(
        concat!(
            ...
            "/examples/ray_reconstruction/output.png"
        ),
        mapped,
        dst_width,
        dst_height,
    ...
    println!("Ray Reconstruction output saved.");
